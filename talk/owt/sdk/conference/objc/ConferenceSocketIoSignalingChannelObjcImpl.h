// ConferenceSocketIoSignalingChannelObjcImpl.h
//
//
#ifndef OWT_CONFERENCE_OBJC_CONFERENCESOCKETIOSIGNALINGCHANNELIMPL_H_
#define OWT_CONFERENCE_OBJC_CONFERENCESOCKETIOSIGNALINGCHANNELIMPL_H_
#include <memory>
#include <future>
#include <queue>
#include <random>
...
#import "talk/owt/sdk/include/objc/OWT/OWTConferenceSignalingChannelProtocol.h"
namespace owt {
...
class ConferenceSocketIoSignalingChannelObjcImpl : public ConferenceSignalingChannelInterface
    : public std::enable_shared_from_this<ConferenceSocketIoSignalingChannelObjcImpl> {
 public:
  explicit ConferenceSocketIoSignalingChannelObjcImpl(id<OWTConferenceSignalingChannelProtocol> signaling_channel);
  virtual ~ConferenceSocketIoSignalingChannelObjcImpl();
  ...
  virtual void RequestConferenceInfo(
      std::function<void(sio::message::ptr room_info)> on_success,
      std::function<void(std::unique_ptr<Exception>)> on_failure);
  virtual void RequestParticipantsList(
 ...
 private:
  ...
  void Emit(const std::string& name,
            ...
            const std::function<void(std::unique_ptr<Exception>)>
                on_failure);
  void DropQueuedMessagesNoCallback();
  ...
  id<OWTConferenceSignalingChannelProtocol> signaling_channel_;
  std::vector<ConferenceSignalingChannelObserverInterface*> observers_;
...
#endif  // OWT_CONFERENCE_OBJC_CONFERENCESOCKETIOSIGNALINGCHANNELIMPL_H_
